...
with InstrumentServer(port=42068) as inserv_primary:#, InstrumentGateway() as remote_gw:
    ...
    inserv_primary.add('ni_analogTasks',       _HERE /  'drivers' / 'ni'       / 'ni_analogTasks.py',    'nidaqAnalogTasks'    , args=[])
    ...
    #inserv_primary.add('e8257d_driver'       , _HERE /  'drivers' / 'agilent'  / 'e8257d.py'           , 'E8257DInstrument'    , args=['GPIB0::2::INSTR']) # EOM
    inserv_primary.add('e8257d_driver2'      , _HERE /  'drivers' / 'agilent'  / 'e8257d.py'           , 'E8257DInstrument'    , args=['GPIB1::19::INSTR']) # MW drive
