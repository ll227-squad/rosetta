...
import rosetta.experiments.t2Hahn.t2Hahn_EXP

class t2HahnFreqDomainWidget(ExperimentWidget):
    def __init__(self):
        params_config = {
            'dataset' : {
                'display_text' : 'Dataset Name',
                'widget' : QtWidgets.QLineEdit('t2Hahn')
            },
            'laser_power': {
            ...
            't_interpulse_delay': {
                'display_text': 'Interpulse Delay Time (us)',
                'widget': SpinBox(
                    value=0.268, 
                    suffix='us',
                    bounds=(1e-6, 1e9), 
        ...
        super().__init__(params_config, 
                        module =    rosetta.experiments.t2Hahn.t2Hahn_EXP,
                        cls =      't2HahnExperiment',
                        fun_name = 't2HahnFreqDomainExperiment',
                        title=     'T2 Hahn Echo in the Frequency Domain with SNSPD counts')
...
def process_t2Hahn_data(sink: DataSink):
...
class FlexLinePlotWidgetWitht2HahnDefaults(FlexLinePlotWidget):
    """Add some default settings to the FlexSinkLinePlotWidget."""
    def __init__(self):
        super().__init__(data_processing_func=process_t2Hahn_data)
        ...
        self.datasource_lineedit.setText('t2Hahn')