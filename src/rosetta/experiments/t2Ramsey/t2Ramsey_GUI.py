...
import rosetta.experiments.t2Ramsey.t2Ramsey_EXP

class t2RamseyWidget(ExperimentWidget):
    def __init__(self):
        params_config = {
            'dataset' : {
                'display_text' : 'Dataset Name',
                'widget' : QtWidgets.QLineEdit('t2')
            },
            'laser_power': {
            ...
            't_pi2': {
                'display_text': 'pi/2 Pulse Time(us)',
                'widget': SpinBox(
                    value=0.134, 
                    suffix='us',
                    bounds=(1e-6, 1e9), 
        ...
        super().__init__(params_config, 
                        module =    rosetta.experiments.t2Ramsey.t2Ramsey_EXP,
                        cls =      't2RamseyExperiment',
                        fun_name = 't2RamseyExperiment',
                        title=     'T2 Ramsey with SNSPD counts')
...
class FlexLinePlotWidgetWitht2Defaults(FlexLinePlotWidget):
